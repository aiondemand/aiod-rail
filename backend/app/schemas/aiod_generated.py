...
class TaxonomyHierarchy(BaseModel):
    term: str = Field(
        ..., description="A short, unique name for the term.", title="Term"
    )
    definition: str = Field(
        ..., description="The definition of the term.", title="Definition"
    )
...
class CaseStudyCreate(BaseModel):
    ...
    aiod_entry: Optional[AIoDEntryCreate] = Field(
        None, examples=[None], title="Aiod Entry"
    )
    ...
    relevant_resource: Optional[List[str]] = Field(
        None, examples=[[]], title="Relevant Resource"
    )
...
class ContactRead(BaseModel):
    ...
    aiod_entry: Optional[AIoDEntryRead] = Field(
        None, examples=[None], title="Aiod Entry"
    )
    email: Optional[List[str]] = Field(
        None, description="An email address.", examples=[[]], title="Email"
...
class DatasetRead(BaseModel):
    ...
    ai_asset_identifier: Optional[str] = Field(
        None, examples=[None], title="Ai Asset Identifier"
    )
...
class OrganisationRead(BaseModel):
    ...
    agent_identifier: Optional[str] = Field(
        None, examples=[None], title="Agent Identifier"
    )
    ai_resource_identifier: Optional[str] = Field(
        None,
        description="This resource can be identified by its own identifier, but also by the resource_identifier.",
...
class CatalogueV2(BaseModel):
    ...
    computational_asset: List[ComputationalAssetRead] = Field(
    ...
    educational_resource: List[EducationalResourceRead] = Field(
