...
@Component({
  selector: 'all-experimetns',
  standalone: true,
  imports: [CommonModule, SearchToolbarComponent, UiErrorComponent, AssetCardComponent],
  templateUrl: '../experiments/pages/public/public.html',
  styleUrls: ['../experiments/pages/public/public.scss'],
})
export class AllExperimentsPage implements OnInit {
