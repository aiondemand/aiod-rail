...
#   timestamp: 2023-11-15T16:35:29+00:00
...
class SearchResult(BaseModel):
    total_hits: int = Field(..., title="Total Hits")
    resources: List = Field(..., title="Resources")
    next_offset: Optional[List] = Field(None, title="Next Offset")
...
class CaseStudyCreate(BaseModel):
    ...
    aiod_entry: Optional[AIoDEntryCreate] = None
    ...
    distribution: Optional[List[Distribution]] = Field(None, title="Distribution")
    has_part: Optional[List[int]] = Field(None, title="Has Part")
    ...
    is_part_of: Optional[List[int]] = Field(None, title="Is Part Of")
    ...
    note: Optional[List[Note]] = Field(
        None, description="Notes on this AI resource.", title="Note"
    )
    ...
    relevant_resource: Optional[List[int]] = Field(None, title="Relevant Resource")
    relevant_to: Optional[List[int]] = Field(None, title="Relevant To")
...
class ContactCreate(BaseModel):
    ...
    email: Optional[List[str]] = Field(
        None, description="An email address.", title="Email"
    )
    location: Optional[List[Location]] = Field(None, title="Location")
