...
class NewsRead(BaseModel):
    ...
    NewsRead - a model defined in OpenAPI
        ...
        name: The name of this NewsRead.
        description: The description of this NewsRead [Optional].
        same_as: The same_as of this NewsRead [Optional].
        headline: The headline of this NewsRead [Optional].
        alternative_headline: The alternative_headline of this NewsRead [Optional].
        ai_resource_identifier: The ai_resource_identifier of this NewsRead [Optional].
        aiod_entry: The aiod_entry of this NewsRead [Optional].
        alternate_name: The alternate_name of this NewsRead [Optional].
        application_area: The application_area of this NewsRead [Optional].
        contact: The contact of this NewsRead [Optional].
        has_part: The has_part of this NewsRead [Optional].
        industrial_sector: The industrial_sector of this NewsRead [Optional].
        is_part_of: The is_part_of of this NewsRead [Optional].
        keyword: The keyword of this NewsRead [Optional].
        media: The media of this NewsRead [Optional].
        note: The note of this NewsRead [Optional].
        research_area: The research_area of this NewsRead [Optional].
        scientific_domain: The scientific_domain of this NewsRead [Optional].
