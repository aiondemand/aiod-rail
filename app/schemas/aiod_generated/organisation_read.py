...
class OrganisationRead(BaseModel):
    ...
    OrganisationRead - a model defined in OpenAPI
        ...
        name: The name of this OrganisationRead.
        description: The description of this OrganisationRead [Optional].
        same_as: The same_as of this OrganisationRead [Optional].
        date_founded: The date_founded of this OrganisationRead [Optional].
        legal_name: The legal_name of this OrganisationRead [Optional].
        ai_relevance: The ai_relevance of this OrganisationRead [Optional].
        agent_identifier: The agent_identifier of this OrganisationRead [Optional].
        ai_resource_identifier: The ai_resource_identifier of this OrganisationRead [Optional].
        aiod_entry: The aiod_entry of this OrganisationRead [Optional].
        alternate_name: The alternate_name of this OrganisationRead [Optional].
        application_area: The application_area of this OrganisationRead [Optional].
        contact: The contact of this OrganisationRead [Optional].
        email: The email of this OrganisationRead [Optional].
        has_part: The has_part of this OrganisationRead [Optional].
        industrial_sector: The industrial_sector of this OrganisationRead [Optional].
        is_part_of: The is_part_of of this OrganisationRead [Optional].
        keyword: The keyword of this OrganisationRead [Optional].
        media: The media of this OrganisationRead [Optional].
        member: The member of this OrganisationRead [Optional].
        note: The note of this OrganisationRead [Optional].
        research_area: The research_area of this OrganisationRead [Optional].
        scientific_domain: The scientific_domain of this OrganisationRead [Optional].
        telephone: The telephone of this OrganisationRead [Optional].
        type: The type of this OrganisationRead [Optional].
