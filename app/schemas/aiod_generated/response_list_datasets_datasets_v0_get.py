...
class ResponseListDatasetsDatasetsV0Get(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    ResponseListDatasetsDatasetsV0Get - a model defined in OpenAPI

    """


ResponseListDatasetsDatasetsV0Get.update_forward_refs()
