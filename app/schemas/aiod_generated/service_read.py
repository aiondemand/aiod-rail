...
class ServiceRead(BaseModel):
    ...
    ServiceRead - a model defined in OpenAPI

        platform: The platform of this ServiceRead [Optional].
        platform_identifier: The platform_identifier of this ServiceRead [Optional].
        name: The name of this ServiceRead.
        description: The description of this ServiceRead [Optional].
        same_as: The same_as of this ServiceRead [Optional].
        slogan: The slogan of this ServiceRead [Optional].
        terms_of_service: The terms_of_service of this ServiceRead [Optional].
        ai_resource_identifier: The ai_resource_identifier of this ServiceRead [Optional].
        aiod_entry: The aiod_entry of this ServiceRead [Optional].
        alternate_name: The alternate_name of this ServiceRead [Optional].
        application_area: The application_area of this ServiceRead [Optional].
        contact: The contact of this ServiceRead [Optional].
        has_part: The has_part of this ServiceRead [Optional].
        industrial_sector: The industrial_sector of this ServiceRead [Optional].
        is_part_of: The is_part_of of this ServiceRead [Optional].
        keyword: The keyword of this ServiceRead [Optional].
        media: The media of this ServiceRead [Optional].
        note: The note of this ServiceRead [Optional].
        research_area: The research_area of this ServiceRead [Optional].
        scientific_domain: The scientific_domain of this ServiceRead [Optional].
        identifier: The identifier of this ServiceRead.
    """
    ...
    slogan: Optional[object] = Field(alias="slogan", default=None)
    terms_of_service: Optional[object] = Field(alias="terms_of_service", default=None)
...
ServiceRead.update_forward_refs()
