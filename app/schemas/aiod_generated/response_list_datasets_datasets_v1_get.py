...
class ResponseListDatasetsDatasetsV1Get(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    ResponseListDatasetsDatasetsV1Get - a model defined in OpenAPI

    """


ResponseListDatasetsDatasetsV1Get.update_forward_refs()
