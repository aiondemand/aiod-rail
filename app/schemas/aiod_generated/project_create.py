...
class ProjectCreate(BaseModel):
    ...
    ProjectCreate - a model defined in OpenAPI
        ...
        doi: The doi of this ProjectCreate [Optional].
        start_date: The start_date of this ProjectCreate [Optional].
        end_date: The end_date of this ProjectCreate [Optional].
        founded_under: The founded_under of this ProjectCreate [Optional].
        total_cost_euro: The total_cost_euro of this ProjectCreate [Optional].
        eu_contribution_euro: The eu_contribution_euro of this ProjectCreate [Optional].
        coordinated_by: The coordinated_by of this ProjectCreate [Optional].
        project_description_title: The project_description_title of this ProjectCreate [Optional].
        project_description_text: The project_description_text of this ProjectCreate [Optional].
        programmes_url: The programmes_url of this ProjectCreate [Optional].
        topic_url: The topic_url of this ProjectCreate [Optional].
        call_for_proposal: The call_for_proposal of this ProjectCreate [Optional].
        founding_scheme: The founding_scheme of this ProjectCreate [Optional].
        image: The image of this ProjectCreate [Optional].
        url: The url of this ProjectCreate [Optional].
        keywords: The keywords of this ProjectCreate.
    """
