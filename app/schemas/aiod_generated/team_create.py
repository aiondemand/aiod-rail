...
class TeamCreate(BaseModel):
    ...
    TeamCreate - a model defined in OpenAPI
        ...
        platform: The platform of this TeamCreate [Optional].
        platform_identifier: The platform_identifier of this TeamCreate [Optional].
        name: The name of this TeamCreate.
        description: The description of this TeamCreate [Optional].
        same_as: The same_as of this TeamCreate [Optional].
        price_per_hour_euro: The price_per_hour_euro of this TeamCreate [Optional].
        size: The size of this TeamCreate [Optional].
        aiod_entry: The aiod_entry of this TeamCreate [Optional].
        alternate_name: The alternate_name of this TeamCreate [Optional].
        application_area: The application_area of this TeamCreate [Optional].
        contact: The contact of this TeamCreate [Optional].
        has_part: The has_part of this TeamCreate [Optional].
        industrial_sector: The industrial_sector of this TeamCreate [Optional].
        is_part_of: The is_part_of of this TeamCreate [Optional].
        keyword: The keyword of this TeamCreate [Optional].
        media: The media of this TeamCreate [Optional].
        member: The member of this TeamCreate [Optional].
        note: The note of this TeamCreate [Optional].
        organisation: The organisation of this TeamCreate [Optional].
        research_area: The research_area of this TeamCreate [Optional].
        scientific_domain: The scientific_domain of this TeamCreate [Optional].
    """
...
TeamCreate.update_forward_refs()
