...
class ExperimentRunsApi:
    ...
    def delete_experiment_run_v1_experiment_runs_id_delete(
        ...
        _param = self._delete_experiment_run_v1_experiment_runs_id_delete_serialize(
            id=id,
    ...
    @validate_call
    def delete_experiment_run_v1_experiment_runs_id_delete_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_experiment_run_v1_experiment_runs_id_delete_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_experiment_run_v1_experiment_runs_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def download_file_from_experiment_run_v1_experiment_runs_id_files_download_get(
        self,
        id: StrictStr,
        filepath: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._download_file_from_experiment_run_v1_experiment_runs_id_files_download_get_serialize(
            id=id,
            filepath=filepath,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def download_file_from_experiment_run_v1_experiment_runs_id_files_download_get_without_preload_content(
        self,
        id: StrictStr,
        filepath: StrictStr,
        _request_timeout: Union[
    ...
    def _download_file_from_experiment_run_v1_experiment_runs_id_files_download_get_serialize(
        self,
        id,
        filepath,
        _request_auth,
    ...
    @validate_call
    def list_files_of_experiment_run_v1_experiment_runs_id_files_list_get_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._list_files_of_experiment_run_v1_experiment_runs_id_files_list_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _list_files_of_experiment_run_v1_experiment_runs_id_files_list_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
