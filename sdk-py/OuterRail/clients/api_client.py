...
import OuterRail.models

from OuterRail.api import rest
from OuterRail import Configuration
from OuterRail.api.api_response import ApiResponse
from OuterRail.api.api_response import T as ApiResponseT
from OuterRail.api.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(OuterRail.models, klass)
