...
class Publication(BaseModel):
    ...
    permanent_identifier: Optional[
        Annotated[str, Field(strict=True, max_length=256)]
    ] = Field(
        default=None, description="A Permanent Identifier (e.g. DOI) for the entity"
    )
    isbn: Optional[
        Annotated[str, Field(min_length=10, strict=True, max_length=13)]
    ] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "permanent_identifier": obj.get("permanent_identifier"),
                "isbn": obj.get("isbn"),
                "issn": obj.get("issn"),
