...
class ExperimentTemplatesApi:
    ...
    def _approve_experiment_template_v1_experiment_templates_id_approve_patch_serialize(
        ...
        if is_approved is not None:
            _query_params.append(("is_approved", is_approved))
    ...
    def get_experiment_templates_count_v1_count_experiment_templates_get(
        ...
        include_pending: Optional[StrictBool] = None,
        only_finalized: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param only_finalized:
        :type only_finalized: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _get_experiment_templates_count_v1_count_experiment_templates_get_serialize(
        ...
        if only_finalized is not None:
            _query_params.append(("only_finalized", only_finalized))
