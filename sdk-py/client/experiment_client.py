...
class Experiments:
    ...
    def create_experiment(self, 
                          file) -> aiod_rail_sdk.ExperimentResponse:
        """
    ...
    def run_experiment(self, 
                       id: str) -> aiod_rail_sdk.ExperimentRunResponse:
        """
    ...
    def get(self, 
            ...
            public: bool = True, 
            offset: int = 0, 
            limit: int = 100) -> list[aiod_rail_sdk.ExperimentResponse]:
        """
    ...
    def update(self,
               id: str,
               file: dict) -> aiod_rail_sdk.ExperimentResponse:
        """
        ...
        with aiod_rail_sdk.ApiClient(self._configuration) as api_client:
            ...
            try:
                api_response = api_instance.update_experiment_v1_experiments_id_put(
                    id=id,
                    experiment_create=experiment_create_instance
                    )
                return api_response
            except Exception as e:
                raise(f'Exception {e}')
    ...
    def get_experiments_run_count(self,
                                  id: int) -> int:
        """
        ...
        with aiod_rail_sdk.ApiClient(self._configuration) as api_client:
            ...
            try:
                api_response = api_instance.get_experiment_runs_of_experiment_count_v1_count_experiments_id_runs_get(id=id)
                return api_response
            except Exception as e:
                print(f'Exception {e}')
